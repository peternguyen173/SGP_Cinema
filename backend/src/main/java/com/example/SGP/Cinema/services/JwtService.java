...
import com.example.SGP.Cinema.exception.MyServerErrorException;
...
public class JwtService {
	...
	public String generateTokenFromRefreshToken(String refresh_token) {
		...
		if (claims != null) {
			...
			System.out.println("Generating token from refresh token with roles: " + list_roles);

			return this.generateToken(list_roles, user);
		}
		return null;
	}

	private String buildToken(Map<String, Collection<?>> extraClaims, UserDetails userDetails, String key, long expiration) {
